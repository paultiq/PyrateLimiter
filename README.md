...
Note: You can simplify initialization by using the factory functions provided in <./pyrate_limiter/limiter_factory.py>, including
...
Example: <./pyrate_limiter/limiter_factory.py>
