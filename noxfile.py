...
PYTEST_MP_ARGS = ["--verbose", "--cov=pyrate_limiter", "--maxfail=1", "-k=sqlite", "tests/test_multiprocessing.py"]

PYTEST_ARGS = ["--verbose", "--maxfail=1", "--numprocesses=auto", "-k=sqlite", "--ignore=tests/test_multiprocessing.py"]
